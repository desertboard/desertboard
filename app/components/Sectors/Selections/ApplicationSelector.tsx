            ...
            <div className="relative  h-[350px] md:h-[400px] lg:h-[450px] w-full group">
              ...
              >
                ...
                <Link
                  ...
                  href={page === "product" ? `/product-details/${productData?.data.find((item:{title:string})=>item.title==application.product).slug}` : `/sectors/${formatLinkForSectors(sectorName)}/${formatLinkForSectors(application.title)}`}
