...
const PrimaryArrowBtn:React.FC<BtnProps> = ({btntitle, iconClr,btnLink}) => {
    return (
      <Link className="text-[#FF671F] w-fit pb-1 flex items-center justify-between border-[#FF671F] border-b-[2px] text-[18px] font-bold group font-nuber-next" href={btnLink}>
        {btntitle}
        <span className="ml-2">
