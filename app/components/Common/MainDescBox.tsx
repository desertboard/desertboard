      ...
      <div className="container m-auto ">
        <div className="lg:flex flex-col lg:flex-row items-center justify-between adst relative xl:pr-[10em] xxl:pr-[20em]">
          <div className="lg:w-1/2 text-left pr-5 pl-5 lg:pl-6 xl:pl-16 py-5 lg:py-20 xl:py-28 opacity-[99%]">
            <h2 className="  text-gray-900 mb-4 text-font28 md:text-[48px] font-black nuber-next">
              {secTitle}
              <span className="text-[#FF671F]">.</span>
            </h2>
            <p className=" nuber-next   mb-6 text-[#151515] font-black opacity-[50%] text-font24">{subTitle}</p>
            <p className="text-font20 text-[#151515] opacity-[75%] max-w-[100%] md:max-w-[88%]">{desc}</p>
            <br />
            <p className="text-font20 text-[#151515] opacity-[75%] max-w-[100%] md:max-w-[88%]">{desc2}</p>
          </div>
