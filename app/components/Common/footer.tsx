...
import youtube from "@/public/assets/images/home/youtube.svg";
  ...
  return (
    ...
    <motion.div className="ola ola-right absolute top-[4%] left-[-9%] w-[45em] rotate-[25deg] " animate={{ x: [0, -20, 0], rotate: [25, 20, 25] }} 
        transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }} >
        <Image className="absolute" src={olar} alt="Description of the image"></Image>
      </motion.div>
    <motion.div className="ola ola-right absolute top-[-19%] left-[-2%] w-[40em] rotate-[5deg] " animate={{ x: [0, -20, 0], rotate: [5, 5, 5] }} 
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }} >
        <Image className="absolute" src={leaff} alt="Description of the image"></Image>
      </motion.div>
      <motion.div className="ola ola-right absolute bottom-[35%] right-[-15%] w-[40em] rotate-[28deg]" animate={{ y: [0, -20, 0], rotate: [28, 35, 28] }} 
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }} >
        <Image className="absolute" src={ola} alt="Description of the image"></Image>
      </motion.div>
      <motion.div className="ola ola-right absolute top-[-15%] right-[30%] rotate-[-44deg] w-[30em] " animate={{ x: [0, -20, 0], rotate: [-44, -40, -44] }} 
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }} >
        <Image className="absolute" src={ola} alt="Description of the image"></Image>
      </motion.div>
                ...
                variants={{
                  ...
                  <a href="#" className="group">
                    <div className="border border-[#FF671F] w-[47px] h-[47px] flex items-center justify-center transition-all duration-300 ease-in-out group-hover:scale-110 group-hover:bg-[#FF671F] group-hover:rounded-md">
                      <Image src={fb} alt="Facebook" className="group-hover:brightness-0 group-hover:invert" />
                    </div>
                  </a>

                  <a href="#" className="group">
                    <div className="border border-[#FF671F] w-[47px] h-[47px] flex items-center justify-center transition-all duration-300 ease-in-out group-hover:scale-110 group-hover:bg-[#FF671F] group-hover:rounded-md">
                      <Image src={lin} alt="LinkedIn" className="group-hover:brightness-0 group-hover:invert" />
                    </div>
                  </a>

                  <a href="#" className="group">
                    <div className="border border-[#FF671F] w-[47px] h-[47px] flex items-center justify-center transition-all duration-300 ease-in-out group-hover:scale-110 group-hover:bg-[#FF671F] group-hover:rounded-md">
                      <Image src={insta} alt="Instagram" className="group-hover:brightness-0 group-hover:invert" />
                    </div>
                  </a>

                  <a href="#" className="group">
                    <div className="border border-[#FF671F] w-[47px] h-[47px] flex items-center justify-center transition-all duration-300 ease-in-out group-hover:scale-110 group-hover:bg-[#FF671F] group-hover:rounded-md">
                      <Image src={youtube} alt="YouTube" className="group-hover:brightness-0 group-hover:invert" />
                    </div>
                  </a>
                </div>
                    ...
                    <motion.div
                     ...
                     variants={{
                      ...
                      <div className="flex flex-col linkq">
                        ...
                        <a href="mailto:info@desertboard.ae" className="transition-all duration-300 ease-in-out hover:text-[#FF671F] hover:translate-x-2">
                          <div className="flex gap-3 items-center">
