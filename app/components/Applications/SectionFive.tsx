  ...
  return (
    <>
      ...
      <motion.div className="ola ola-right absolute top-5 right-[-10%] w-[40em]" animate={{ y: [0, -20, 0], rotate: [0, -1, 0] }}
        ...
        <Image className="absolute" src={lfbef} alt="Description of the image"></Image>
      </motion.div>
      ...
      <div className="lfbef ola-right absolute bottom-0 left-[-10%] w-[40em] rotate-180">
        ...
        <div className="container ">
          <div><h2 className="heavydark mb-6 md:mb-10">Customizable Finishes<span className="text-orange">.</span></h2></div>
