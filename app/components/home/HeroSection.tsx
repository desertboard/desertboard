    ...
    <>
      <section className="relative h-[98vh] bg-cover bg-center flex items-center justify-center text-center">
        ...
        <figure className="absolute h-[98vh] top-0   w-full  -z-40">
          <Image
            className="w-screen h-[98vh] absolute object-cover"
            src={Banner}
            width={1000}
            height={800}
            alt=""
        ...
        <div className="relative z-10 text-white px-6 top-0 lg:top-[120px]">
          ...
          <Link
            href="#"
            className="flex group w-fit m-auto gap-2 rounded-none inline-block px-6 py-3 border border-white text-white btnhs hover:bg-white hover:text-black transition rounded-md"
          >
            Know More<Image src={readarrow} alt="icn1" className="fiterwt transition-all duration-300 group-hover:translate-x-2 " />
          </Link>
        </div>
      </section>
        ...
        <div className="container m-auto ">
          <div className="flex flex-col lg:flex-row items-center justify-between    adst relative">
            <div className="lg:w-1/2 text-left px-16 py-5 lg:py-20 opacity-[99%]">
              ...
              <p className=" nuber-next   mb-6 text-[#151515] font-black opacity-[50%] text-font24">
              ...
              <p className="text-font20 text-[#151515] opacity-[75%] max-w-[100%] md:max-w-[88%]">
                ...
                by the rich legacy and the vision of the UAE&apos;s founding
                father, Sheikh Zayed bin Sultan Al Nahyan, DesertBoard®
                successfully produced the first engineered board in 2021.
              </p>
            </div>
      ...
      <video
        ref={videoRef}
        className=" "
        src="/assets/images/home/liftvdo.mp4"
        poster="/assets/images/mn.jpg"
        controls={false}
         width={1080}
          height={740}
        playsInline
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        {!isPlaying && ( // Show the button only if video is paused
          <button
            className="bg-white bg-opacity-20 rounded-sm px-10 py-6 transition duration-300 hover:bg-opacity-50"
            onClick={togglePlay}
                      >
      ...
      <section className="py-20 md:py-15 py-10 insp-mn relative darkbanner">
        <div className="container m-auto">
          <div className="text-left mb-10">
            ...
            <p className="text-font20 text-[#151515] opacity-[75%]  max-w-[75ch]">
              PSB® boards&apos; diverse product lineup is used in everything
              from house building, furniture, and interior design to mass timber
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="relative group bg-gray-800 csmn overflow-hidden ">
              ...
              <div className="absolute top-0 text-white w-full p-8">
                ...
                <p className="mt-5 w-full opacity-0 group-hover:opacity-75 w-[250px] group-hover:w-full transition-opacity duration-300 text-font20 leading-[1.5]">
                PSB® board’s high strength and load-bearing capacity meet the needs of builders, constructors, and engineers.
                </p>
                <a
                  href="#"
                  className="relative flex gap-2 max-w-fit top-3  opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-300 text-font18 font-black leading-[1.5] rmbtn "
                >
            ...
            <div className="relative group bg-gray-800 csmn overflow-hidden">
              ...
              <div className="absolute top-0 text-white w-full p-8">
                ...
                <p className="mt-5 w-full opacity-0 group-hover:opacity-75 w-[250px] group-hover:w-full transition-opacity duration-300 text-font20 leading-[1.5]">
                PSB® board’s load-bearing capacity and moisture resistance makes them ideal for outdoor applications.
                </p>
                <a
                  href="#"
                  className="relative flex gap-2 max-w-fit top-3  opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-300 text-font18 font-black leading-[1.5] rmbtn "
            ...
            <div className="relative group bg-gray-800 csmn overflow-hidden">
              ...
              <div className="absolute top-0 text-white w-full p-8">
                ...
                <p className="mt-5 w-full opacity-0 group-hover:opacity-75 w-[250px] group-hover:w-full transition-opacity duration-300 text-font20 leading-[1.5]">
                PSB® board’s versatility makes them a preferred choice for a wide range of interior applications.
                </p>
                <a
                  href="#"
                  className="relative flex gap-2 max-w-fit top-3  opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-300 text-font18 font-black leading-[1.5] rmbtn "
            ...
            <div className="relative group bg-gray-800 csmn overflow-hidden">
              ...
              <div className="absolute top-0 text-white w-full p-8">
                ...
                <p className="mt-5 w-full opacity-0 group-hover:opacity-75 w-[250px] group-hover:w-full transition-opacity duration-300 text-font20 leading-[1.5]">
                PSB®  board’s screw-withdrawal & smooth finish capabilities makes them ideal for booths, stands and prefabricated structures.
                </p>
                <a
                  href="#"
                  className="relative flex gap-2 max-w-fit top-3  opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-300 text-font18 font-black leading-[1.5] rmbtn "
        ...
        <div className="container m-auto">
          <div className="flex justify-between mb-8 items-end">
            ...
            <div className="flex gap-2 items-center group">
              <div>
                <p className="relative flex gap-2 max-w-fit    transition-opacity duration-300 text-font18 font-black leading-[1.5] rmbtn">
                  Read More
                </p>
              </div>{" "}
                  ...
                  <div className="relative    bg-cover bg-center p-6">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center  transition-all duration-500 group-hover:inset-1">
                      <Image
                        src={iconsl1}
                        alt="Thumbnail"
                        className="w-20 h-20 transform transition-all duration-500 group-hover:scale-75 group-hover:translate-x-[-133%] group-hover:translate-y-[-215%]"
                      />
                    </div>
                    ...
                    <div className=" opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-500 group-hover:delay-300 delay-0">
                      ...
                      DesertBoard has designed its PSB® to be zero-emissions. This greener alternative to wood-based products (example: MDF, particleboard, and plywood) includes zero formaldehyde.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center min-h-[460px]">
                  <div className="relative    bg-cover bg-center p-6">
                    ...
                    <div className=" opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-500 group-hover:delay-300 delay-0">
                      ...
                      <p className="text-sm text-black opacity-[75%] mt-2">
                      As proved by Desert Board's life cycle assessment (LCA) and Environmental Product Declaration (EPD), 30% of the factory’s purchased electricity comes from clean sources (nuclear & solar).
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center min-h-[460px]">
                  <div className="relative    bg-cover bg-center p-6">
                    ...
                    <div className=" opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-500 group-hover:delay-300 delay-0">
                      ...
                      <p className="text-sm text-black opacity-[75%] mt-2">
                      As of 2025, DesertBoard employes a workforce of 284 team members, including 156 positions at our factory and 128 roles within the company's back-office operations.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center min-h-[460px]">
                  <div className="relative    bg-cover bg-center p-6">
                    ...
                    <div className=" opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-500 group-hover:delay-300 delay-0">
                      ...
                      <p className="text-sm text-black opacity-[75%] mt-2">
                      Desert Board's engineered solutions are improving the construction industry while combating deforestation. Palm Strand Board®’s outstanding properties include high strength, versatility, fire resistance, sound isolation, among many more.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center min-h-[460px]">
                  <div className="relative    bg-cover bg-center p-6">
                    ...
                    <div className=" opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-500 group-hover:delay-300 delay-0">
                      ...
                      <p className="text-sm text-black opacity-[75%] mt-2">
                      At DesertBoard, inclusivity is a key pillar, with a multicultural talent pool that values diversity in ethnicity, religious background, and an increasing female shares of our workforce.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center min-h-[460px]">
                  <div className="relative    bg-cover bg-center p-6">
                    ...
                    <div className=" opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-500 group-hover:delay-300 delay-0">
                      ...
                      <p className="text-sm text-black opacity-[75%] mt-2">
                      DesertBoard is proudly preserving the UAE’s cultural and natural heritage by collecting annually regenerated palm frond biomass, preventing it from ending up in landfills or being incinerated, which would otherwise release CO2 or methane into the atmosphere.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center min-h-[460px]">
                  <div className="relative    bg-cover bg-center p-6">
                    ...
                    <div className=" opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-500 group-hover:delay-300 delay-0">
                      ...
                      <p className="text-sm text-black opacity-[75%] mt-2">
                      Every year, DesertBoard sources hundreds of thousands of tons of palm residues from local farmers and converts them into PSB®. To raise awareness on responsible consumption and production, DesertBoard showcased its’ bio-economy model at 19 regional and global forums
                      in 2024.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-center min-h-[460px]">
                  <div className="relative    bg-cover bg-center p-6">
                    ...
                    <div className=" opacity-0 group-hover:opacity-100 w-[250px] group-hover:w-full transition-opacity duration-500 group-hover:delay-300 delay-0">
                      ...
                      <p className="text-sm text-black opacity-[75%] mt-2">
                      By producing 100% sustainable, zero-formaldehyde boards, DesertBoard is helping decarbonize the built environment and support the Net Zero initiatives of the UAE, KSA, EU, and India.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 items-center">
              <div>
                <p className=" mb-0 text-gray-900   text-[36px] leading-none font-black">
                  ...
                  <span className="text-[#FF671F] mb-0     text-[36px] ">
                    .
                  </span>
                </p>
              </div>
                ...
                <div className="w-full flex items-center justify-between  ">
                  <div className="relative w-full ">
                    ...
                    <input
                      type="email"
                      placeholder="Email"
                      className="emilfs w-full p-3 pl-5 pr-[110px] text-font18 leading-none border-b-2 border-[#002D28]   focus:outline-none   focus:border-b-[#FF671F]"
                    />

                    {/* Subscribe Button */}
                    <button
                      type="button"
                      className="absolute top-0 right-0 mt-1 mr-1 px-5 py-2 text-sm font-bold text-[#002D28] flex gap-2 items-center transition-all"
                    >
                      Subscribe
                      <svg
                        width="11"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 items-center">
              ...
              <div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ">
                  <div>
                    <div>
                      <p className="text-[24px] text-white font-black mb-3 md:mb-5 pb-3 md:pb-5 border-b-2 border-[#ffffff10] w-fit leading-1">
                        Quick Links
                      </p>
                    </div>
